...
public class ExtendedValidate
{
    ...
    {
        assert (messagePrefix != null);
        Validate.isTrue(value > 0, messagePrefix + " should be positive, found "
    ...
    /**
     * Checks that a floating point value is within an expected set of inclusive
     * bounds.
     * 
     ...
     * 
     * @param messagePrefix  The string to print before the error message if the

...
import com.centuryglass.chunk_atlas.mapping.MapImage;
...
public abstract class Mapper
{
            ...
            int heightInChunks, int pixelsPerChunk)
    {
        ...
        map = new MapImage(
                new File(imageDir, getTypeName() + "_" + regionName),
     ...
     * Mapper subclasses should extend this method if there's anything they
     * need to do after processing chunks to complete the map.
     *
